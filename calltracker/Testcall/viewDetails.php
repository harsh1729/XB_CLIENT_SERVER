...
else
{
	...
	$checkAgentIdResult = mysql_query($checkAgentIdQuery);
	$checkAgentIdRowCount = mysql_num_rows($checkAgentIdResult);
...
<html>
	...
	<div class="container-fluid" id="main_container">
		<div class="row">
			<div class="col-md-12">
				...
				<table id="clientReportTable" data-url="ajaxRequests/getAgentCallDetails.php?id=<?php echo $_REQUEST['id']; ?>" >
					<thead>
						<tr>
							...
							<th data-field='location' data-formatter='locationFormatter' data-halign='center' data-align='center'>Location</th>
						</tr>
    ...
    <script>
		...
		function locationFormatter(value,row,index)
		{
			...
			//console.log(value);
			if(value != 0)
				var eyeRow = "<span class='glyphicon glyphicon-eye-open locationBtn'  style='color:#12c;font-size:16px;' data-lattitude='"+locationArray[0]+"' data-longitude='"+locationArray[1]+"'  data-target='#customModal' data-toggle='modal'></span>";
			else
