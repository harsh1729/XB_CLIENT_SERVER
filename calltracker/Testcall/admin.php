	...
	<body>
	    ...
	    <div class="navmenu navmenu-inverse navmenu-fixed-left offcanvas-xs" id="leftSideMenu">
			...
			<ul class="nav navmenu-nav">
	        	...
	        	<?php
	        		if($isSuperAdmin == 1)
	        			echo "<li class='active'><a href='admin.php' style='color:#3ec15b'><span class='fa fa-user'></span> Admin</a></li>";
	        	?>
        	...
        	<div class="col-md-12">
            	<div class="panel panel-info">
                	<div class="panel-heading" id="allAdminHeading">
                    	<i class="fa fa-paw"></i> All Admins
                    </div>
        	...
        	<div class="col-md-12">
	            <div class="panel panel-info">
                    ...
                    <div class="panel-body">
						<form id="newAdmin" method="POST" action="ajaxRequests/addNewAdmin.php">
                            ...
                            <div class="row">
                            	...
                            	<div class="col-md-4">
                                	<button type="submit" class="btn btn-success btn-block btn-lg">
                                    	<span class="glyphicon glyphicon-save"></span> Create Admin
                                    </button>
                                </div>
                            	<div class="col-md-4">
                                </div>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
      	<form id="formUpdateAdmin" method="POST" action="ajaxRequests/updateAdmin.php">
         ...
         <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-success" id="updateAdmin" data-id="-1" >
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            ...
            <button type="button" class="btn btn-danger" id="DeleteAdmin" data-id="-1" >
               Delete
            </button>
         </div>
      </div>
    ...
    <script>
		function updateAllAdmins()
		{
			...
			$.ajax({
					url:"ajaxRequests/getAllAdmins.php",
					data:{},
					type:"POST",
					async:true,
					dataType:"json",
		...
		$(document).ready(function(e) {
    		...
    		$('#formUpdateAdmin').on('submit',function(e){
				...
				var adminId = $("#updateAdmin").data('id');
				var tempArray = {"name":"adminId","value":adminId};
			...
			$('#editModal').modal({
				...
				var modal = $(this);
				modal.find('#updateAdmin').data('id',adminId);
			...
			$('#customModal').modal({
                ...
                show:false
						...
						var modal = $(this);
						modal.find('#DeleteAdmin').data('id',adminId);
				});
			
			$('#DeleteAdmin').on('click',function(){
				$('#customModal').modal('hide');
				var adminId = $('#DeleteAdmin').data('id');
				$('#loadingDiv').removeClass('hidden');
				$.ajax({
						async: true,
						type: 'POST',
						url:"ajaxRequests/deleteAdmin.php",
						dataType:'json',
