							...
							<select class="form-control" id="areacode">
								...
								<?php
...

									{
										...
										echo "<option value='".$area['id']."'>".$area['name']." [".$area['areacode']."]</option>";
...
<div class="container-fluid" style="min-height:89vh;">
	...
	<div class="row" style="margin-top:10px;">
		...
		<div class="col-md-7" style="max-height:450px;min-height:300px;overflow-y:auto;" id="today_epapers_container">
			...
			<?php foreach ($allepapers as $index => $val): ?>
				...
				<?php endif; ?>
						...
						<div class="col-md-4">
							...
							<div class="well well-sm" style="">
								...
								<img src="<?=$val['preview'];?>" alt="" class="center-cropped" style="">

								<div style="color:#666;"><span class="glyphicon glyphicon-globe"></span> <?=$val['area'];?></div>

								<div>

									<span class="glyphicon glyphicon-eye-open btn"></span>

									<span data-epaperid="<?=$val['id'];?>" class="glyphicon glyphicon-remove btn pull-right" data-target="#customModal" data-toggle="modal"></span>
				...
				<?php if(($index+1)%3 == 0 || $index+1 == count($allepapers)) : ?>
	...
	<div class="modal fade" id="Delete_allnews_Modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	   	<div class="modal-dialog">
	    	<div class="modal-content">
		        ...
		        <div class="modal-body">
		        	This will delete all the epaper of the all epaper !
		        </div>
		        <div class="modal-footer">
		           	<button type="button" class="btn btn-default" data-dismiss="modal">
		            	Close
