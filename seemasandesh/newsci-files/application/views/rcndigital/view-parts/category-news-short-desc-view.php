				...
				<div class="panel panel-default" style="margin-top:0px;margin-bottom:4px;">
					...
					<?php	if(count($singleNews['images']) !== 0)
						...
						<div class="row">
							<div class="col-md-12 col-xs-12">
								<div class="imgSlider">								
									<?php foreach($singleNews['images'] as $singleImage): ?>									
					...
					<?php	} ?>
						<div class="row">
							<div class="col-md-12 col-xs-12">
								<div class="row">
									<div class="col-md-12 col-xs-12">
										<h6 class="pull-left" style="color:#333;margin-top:0;overflow:hidden;max-height:2.5em;min-height:2.5em;margin-bottom:0px;line-height:1.2em"><?=$singleNews['heading'];?></h6>
								...
								{
									echo "<p style='color:#999;font-size:12px;height:132px;overflow:hidden;margin-top:8px;line-height:1.38em;'>";
