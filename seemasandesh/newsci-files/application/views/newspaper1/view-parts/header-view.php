...
<link rel="shortcut icon" type="image/x-icon" href="<?=base_url();?><?=$datafoldername?>images/favicon.ico"/>
  ...
  align-items: center;
	...
	<body>
		<?=$navigation;?>
		<div id="loading_bar" style="height:700px;width:100%; background-color:#c3161c; z-index:1100; position:fixed;">
			<img src="<?=base_url($datafoldername.'images/preloader.gif');?>" style="margin-top:18%; margin-left:38%;">
		</div>
...
?>
							...
							<div class="col-md-6 col-xs-6">
								...
								<img src='<?=base_url()?><?=$datafoldername?>/images/bd24header1.png' class="img-responsive center-block" style="max-height:150px;margin-top:10px;" />
							</div>
