<?php
class Epaper_multi_del extends MY_Controller
{
	...
	function index()
	{
		if( $this->addons_model->client_have_addon($this->session->userdata('client_id'),"Epaper",1) )
		{
			...
			$navigationData['css'] = $this->load->view('administrator/view-parts/epaper_multi_del-view-css-files1','',TRUE);
			...
			$data['data'] = $this->load->view('administrator/epaper_multi_del-view1',$headerData);
			
			$data['js'] = $this->load->view('administrator/view-parts/epaper_multi_del-view-js-files1','',TRUE);
