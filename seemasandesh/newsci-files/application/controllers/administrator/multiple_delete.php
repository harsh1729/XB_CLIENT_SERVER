<?php
class Multiple_delete extends MY_Controller
{
	...
	function index()
	{
		...
		$navigationData['css'] = $this->load->view('administrator/view-parts/multipleDelete-view-css-files','',TRUE);
		...
		$data['data'] = $this->load->view('administrator/multipleDelete-view',$headerData);
		
		$data['js'] = $this->load->view('administrator/view-parts/multipleDelete-view-js-files','',TRUE);
