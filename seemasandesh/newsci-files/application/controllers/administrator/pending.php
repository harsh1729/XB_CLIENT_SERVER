...
class Pending extends MY_Controller
{
	...
	function index()
	{
		...
		$navigationData['css'] = $this->load->view('administrator/view-parts/pending-view-css-files','',TRUE);
		...
		$data['data'] = $this->load->view('administrator/pending-view',$headerData);
		
		$data['js'] = $this->load->view('administrator/view-parts/pending-view-js-files','',TRUE);
