...
class Notification extends MY_Controller
{
	...
	function index()
	{
		if( $this->addons_model->client_have_addon($this->session->userdata('client_id'),"notification",1) )
		{
			...
			$navigationData['css'] = $this->load->view('administrator/view-parts/notification-view-css-files','',TRUE);
			$headerData['header'] = $this->load->view('administrator/view-parts/header-view',$navigationData,TRUE);
			
			$data['data'] = $this->load->view('administrator/notification-view',$headerData);
			
			$data['js'] = $this->load->view('administrator/view-parts/notification-view-js-files','',TRUE);
