...
class News extends MY_Controller
{
	...
	function index()
	{
		...
		$navigationData['css'] = $this->load->view('administrator/view-parts/news-view-css-files','',TRUE);
		...
		$data['data'] = $this->load->view('administrator/news-view',$headerData);
		
		$data['js'] = $this->load->view('administrator/view-parts/news-view-js-files','',TRUE);
