<?php
class Rivernrates extends MY_Controller
{
	...
	function index()
	{
		if( $this->addons_model->client_have_addon($this->session->userdata('client_id'),"Rivernrates",1) )
		{
			$dataToNav['page'] = "rivernrates";
			...
			$navigationData['css'] = $this->load->view('administrator/view-parts/rivernrates-view-css-files','',TRUE);
			...
			$data['data'] = $this->load->view('administrator/rivernrates-view',$headerData);
			
			$data['js'] = $this->load->view('administrator/view-parts/rivernrates-view-js-files','',TRUE);
