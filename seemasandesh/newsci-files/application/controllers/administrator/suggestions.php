...
class Suggestions extends MY_Controller
{
	...
	function index()
	{
		...
		$navigationData['css'] = $this->load->view('administrator/view-parts/suggestions-view-css-files','',TRUE);
		$headerData['header'] = $this->load->view('administrator/view-parts/header-view',$navigationData,TRUE);
		
		$data['data'] = $this->load->view('administrator/suggestions-view',$headerData);
		
		$data['js'] = $this->load->view('administrator/view-parts/suggestions-view-js-files','',TRUE);
