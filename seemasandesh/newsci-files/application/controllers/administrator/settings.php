...
class Settings extends MY_Controller
{
	...
	function index()
	{
		...
		$navigationData['css'] = $this->load->view('administrator/view-parts/settings-view-css-files','',TRUE);
		$headerData['header'] = $this->load->view('administrator/view-parts/header-view',$navigationData,TRUE);
		
		$data['data'] = $this->load->view('administrator/settings-view',$headerData);
		
		$data['js'] = $this->load->view('administrator/view-parts/settings-view-js-files','',TRUE);
